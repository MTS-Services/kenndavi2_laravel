import { MinusIcon, PlusIcon, ShoppingCartIcon, Star, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
                    ...
                    <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] xl:gap-16">
                        ...
                        <div className="w-full">
                            <div className="w-full overflow-hidden aspect-square sm:aspect-[4/3] lg:aspect-[5/4]">
                                <img src={selectedImage} alt="Sweet & Smoky BBQ Sauce" className="h-full w-full object-cover" />
                            </div>
                            <div className="mt-3 md:mt-4 flex flex-wrap gap-2 md:gap-3">
                                {productImages.map((image) => (
                                    <button
                                        ...
                                        className={`relative flex-none overflow-hidden rounded-lg border transition-all w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-[72px] lg:h-[72px] xl:w-24 xl:h-24 ${selectedImage === image ? 'border-red-500 ring-2 ring-red-500 ring-offset-2 ring-offset-white' : 'border-gray-200 hover:border-red-400'}`}
                                    >
                                        <img src={image} alt="Sweet & Smoky BBQ Sauce thumbnail" className="h-full w-full object-cover" />
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="space-y-6 lg:space-y-8">
                            <div className="flex flex-wrap items-center gap-3 text-xs font-semibold text-gray-500">
                                ...
                                <span className="font-public-sans text-sm font-semibold text-text-title">
                                    ...
                                    <span className="font-public-sans text-sm font-normal text-text-gray-300"> 3,197 User Feedback</span>
                                </span>
                            </div>

                            <div className="space-y-3">
                                <h1 className="font-bebas-neue text-[32px] font-normal uppercase text-text-title">Sweet & Smoky Perfection in Every Drop</h1>
                                <p className="font-aktiv-grotesk text-base font-normal text-text-body">
                                    A rich and smooth sweet BBQ sauce crafted with the perfect balance of sweetness and smoky flavor. Ideal for grilling, dipping, or glazing to make every bite irresistibly delicious.
                                </p>
                            </div>

                            <div>
                                <div>
                                    <h2 className="font-bebas-neue text-2xl font-normal uppercase text-text-title">Ingredients</h2>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <div className="py-2">
                                            <p className="mt-2 font-public-sans text-sm font-normal text-text-body">
                                                Availability: <span className="font-semibold text-text-green"> In Stock</span>
                                            </p>
                                        </div>
                                        <div className="flex flex-wrap items-end gap-3">
                                            <h3 className="font-public-sans text-2xl font-semibold text-text-green">$16.99</h3>
                                            <span className="bg-bg-our-story py-1.5 px-2.5 font-public-sans text-sm font-semibold uppercase text-text-green">21% OFF</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-wrap items-center gap-4">
                                        <div className="inline-flex items-center gap-9 border border-bg-gray-300 p-5">
                                            <button type="button" onClick={handleDecrease} className="text-text-body">
                                                <MinusIcon className="h-4 w-4" />
                                            </button>
                                            <span className="mx-4 w-6 text-center font-public-sans text-base font-normal text-text-body">
                                                {quantity.toString().padStart(2, '0')}
                                            </span>
                                            <button type="button" onClick={handleIncrease} className="text-text-body">
