...
export default function EditTag() {
    ...
    const tag = props.tag as { id: number; name: string; status: string };

    const { data, setData, put, processing, errors, reset } = useForm<TagFormData>({
        name: tag.name,
        status: tag.status,
    });
    ...
    function handleSubmit(e: React.FormEvent) {
        ...
        put(route('admin.tm.update', tag.id), {
